  ...
  return (
    <CarouselItem key={market.id}>
      <Link
        ...
        className="flex min-h-[600px] w-auto flex-col-reverse justify-between rounded-20 bg-linear-to-b from-surface-surface-0 to-surface-primary-low-em shadow-2 ring-1 ring-outline-base-em md:h-72 md:min-h-fit md:flex-row 2xl:h-96"
      >
