            ...
            <div className="flex space-x-4" key={index}>
              <div
                className={cx(
                  ...
                  isWinner &&
                    (index === 0
                      ? 'border-surface-surface-2 bg-linear-to-b from-neutral-inverse-white-alpha-4 to-text-success-base-em'
                      : 'border-surface-surface-2 bg-linear-to-b from-neutral-inverse-white-alpha-4 to-text-danger-base-em')
                )}
              >
